    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div
          ...
          className={`relative border-2 border-dashed rounded-lg p-8 text-center transition-all duration-200 ${dragOver ? 'scale-102' : ''
            }`}
          style={{
        ...
        <div className="mt-4 pt-4 grid grid-cols-1 md:grid-cols-2 gap-4"
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => onUpdateMetadata(fileData.id, 'privacy', e.target.value)}
              className="w-full px-3 py-2 border rounded-md text-sm ..."
              style={{ borderColor: theme.secondary, backgroundColor: theme.background, color: theme.text }}
            >
